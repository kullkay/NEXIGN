...
Также рекомендую сделать данный шаг опциональным и делать всегда, только при мердж реквестах в мастер или
релизных прогонах, так как полное сканирование проекта может занять большой промежуток времени.
