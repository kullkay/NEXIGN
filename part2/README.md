...
1) Вызов сканирования, через легкий PT AI Plugin
...
4) Вызов создания отчета PT AI Plugin
   ...
   - При успехе, отправить отчет в соответствующую директорию
5) При нарушении политики безопасности, остановить деплой проекта 
